...
//     return Scaffold(
//       appBar: AppBar(
//         title: const Text('Firestore Stream Example'),
//       ),
...
//                   radius: 25,
//                   backgroundImage:
//                       NetworkImage(data['imagePath'] ?? 'default_image_url'),
//                 ),
//                 title: Text(data['username'] ?? 'No Title'),
//                 subtitle: Column(
//                   crossAxisAlignment: CrossAxisAlignment.start,
//                   children: [
//                     Text(data['mobileNumber'] ?? 'No Description'),
//                     Text(data['qualification'] ?? 'No Additional Text'),
//                     Text(data['place'] ?? 'No Additional Text'),
//                   ],
//                 ),
//               );
//             },
